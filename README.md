...
| `pull_request_branch`         | No       | The pull request branch name. (If provided, the action will force push to the branch)                                                                                                                                                                                               | "gh-actions-update-<timestamp>"                | "github/actions-update"                    |
